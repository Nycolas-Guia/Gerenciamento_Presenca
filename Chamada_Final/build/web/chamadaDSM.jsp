            ...
            <div v-if="shared.session">
                ...
                <form class="form-inline" action="/Chamada_Final">
                    <div class="container p-2 bg-white text-dark">
                        <div class="row container-fluid">                
                            <table class="table">
                                <tr v-for="aluno in lista" :key="aluno.rowid">                                    
                                    <div class="col-xl-5-text-center">{{ aluno.nome }}</div>
                                    <div class="col-xl-5-text-center">{{ aluno.faltas }}</div>                                    
            ...
            methods: {
                async request(url = "", method, data) {
                    try {
                        ...
                        else {this.error = response.statusText;}
                    } catch (e) {
                        this.error = e;
                        return null;
                    }
